...
import { Alert, Button, Card, Form, Input, Modal, Popconfirm, Radio, Select, Space, Table, Tag, Typography, message } from 'antd'
import { ArrowLeftOutlined, MessageOutlined, PlusOutlined, ReloadOutlined } from '@ant-design/icons'
import { useNavigate } from 'react-router-dom'
import { api } from '@/services/api'

type Config = { enabled: boolean; app_id: string; app_secret: string; last_test_success: boolean | null; last_error: string | null; effective_app_id: string; use_cloud_config: boolean; response_detail: string }
...
export default function FeishuBotSettings() {
  ...
  return <div>
    ...
    <Card title="回复详细程度" style={{ marginTop: 16 }}>
      <Typography.Paragraph type="secondary" style={{ marginTop: 0 }}>控制机器人回答的展开程度；修改立即生效，无需填写应用凭据。</Typography.Paragraph>

...
class PromptTemplate:
    ...
    DEFAULT_SYSTEM_PROMPT = """你是一个智能问答助手，基于提供的知识库内容来回答问题。

## 规则
1. 仅根据下方【参考知识】中的内容回答，不要编造信息
2. 如果参考知识中没有相关信息，请明确告知用户"抱歉，知识库中暂无相关信息"
3. 回答要简洁、准确，优先使用中文
4. 如果参考知识中有多个相关片段，请综合整理后给出完整回答
...
请回答："""
    ...
    SOURCE_CITATION_PROMPT = """你是一个智能问答助手，基于提供的知识库内容来回答问题。
